...
describe('admin UsageTable tooltip', () => {
  ...
  it('shows requested and upstream reasoning effort when group policy changes it', () => {
    const wrapper = mount(UsageTable, {
      props: {
        data: [{ ...baseImageRow, reasoning_effort: 'high', upstream_reasoning_effort: 'medium' }],
        loading: false,
        columns: [],
      },
