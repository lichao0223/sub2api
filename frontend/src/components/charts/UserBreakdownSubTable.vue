...
const getUserLabel = (user: UserBreakdownItem): string => {
  return user.username?.trim() || user.email || `User #${user.user_id}`
}
...
const formatCost = (value: number | undefined | null): string => formatUsageCost(value)
</script>
