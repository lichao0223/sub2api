    ...
    >
      ...
      >
        <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
          <input v-model="batchAssignEnabled" type="checkbox" :disabled="submitting || assignForm.all_active" @change="resetAssignUsers" />
        ...
        <label class="flex items-start gap-3 rounded-md border border-gray-200 p-3 dark:border-dark-700">
          <input
            ...
            :disabled="submitting || batchAssignEnabled"
...
const simpleUserLabel = (user: Pick<SimpleUser, 'username' | 'email'>) =>
...
const handleAssignSubscription = async () => {
  ...
  try {
    ...
    } else if (batchAssignEnabled.value) {
