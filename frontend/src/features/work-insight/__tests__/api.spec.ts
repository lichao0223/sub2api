...
describe('work insight api', () => {
  ...
  it('uses the isolated admin endpoints and omits empty filters', async () => {
    ...
    expect(client.get).toHaveBeenNthCalledWith(3, '/admin/ai-work-insights/analyzer-accounts')
    expect(client.post).toHaveBeenCalledWith('/admin/ai-work-insights/endpoint/probe', {})
    expect(client.get).toHaveBeenNthCalledWith(4, '/admin/ai-work-insights/daily', { params: { start_date: '2026-08-01', task_category: '问题排查', page: 2, page_size: 20 } })
    expect(client.get).toHaveBeenNthCalledWith(5, '/admin/ai-work-insights/overview', { params: { start_date: '2026-08-01', task_category: '问题排查' } })
    expect(client.get).toHaveBeenNthCalledWith(6, '/admin/ai-work-insights/daily/7')
  })
})
