...
import costManagementAPI, { type AccountCostInput, type AccountCostRow, type CostAnalysis, type CostJob, type CostOverview, type CostPlan, type CostPriceVersion, type CostSubscriptionUnit } from '@/api/admin/costManagement'
...
const overviewCards=computed(()=>[{label:'真实总成本',value:money(overview.total_cost_cny)},{label:'按量成本',value:money(overview.dynamic_cost_cny)},{label:'固定成本',value:money(overview.fixed_cost_cny)},{label:'待核算',value:overview.pending_count+' 条'}])
