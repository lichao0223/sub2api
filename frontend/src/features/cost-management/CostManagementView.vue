...
const accountDialog=ref(false),batchMode=ref(false),accountFormSubmitting=ref(false),editingAccount=ref<number>(),editingAccountConfigured=ref(false),accountForm=reactive<any>({cost_mode:'metered',plan_id:undefined,subscription_unit_id:undefined,new_subscription_unit_name:'',effective_from:new Date().toISOString().slice(0,16),effective_to:'',exclude_reason:''})
