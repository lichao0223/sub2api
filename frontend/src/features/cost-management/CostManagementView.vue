...
async function openPriceHistory(x:CostPlan){priceHistoryPlan.value=x;priceHistoryDialog.value=true;priceHistory.value=await costManagementAPI.priceHistory(x.id)}
