export default {
    ...
    usage: {
      ...
      nonworkCalendarDescription: 'Sync and maintain annual offdays. Manually added dates are preserved during later syncs.',
      calendarConfirmed: 'Confirmed',
      calendarPredicted: 'Predicted',
      noCalendarStatus: 'No calendar status',
      syncCalendar: 'Sync Calendar',
      syncSelectedYear: 'Sync Selected Year',
      yearOffdays: '{year} Offdays ({count})',
      calendarDate: 'Date',
      calendarName: 'Name',
      calendarSource: 'Source',
      calendarManual: 'Manual',
      noOffdays: 'No offday data for this year',
      addOffday: 'Add Offday',
      calendarNamePlaceholder: 'Optional, e.g. company holiday',
      weekend: 'Weekend',
      removeOffday: 'Remove',
