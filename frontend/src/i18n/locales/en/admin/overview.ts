export default {
    ...
    users: {
      ...
      editUser: 'Edit User',
      apiKeyManagement: {
        action: 'APIKey Management',
        title: 'Bulk API Key Management',
        group: 'Group',
        selectGroup: 'Select a group',
        selectGroupHint: 'Select a group to manage its API keys.',
        user: 'User',
        name: 'Name',
        selected: '{count} API keys selected',
        selectedAll: 'All {count} API keys in this group selected',
        ...
        deleteUngrouped: 'Delete system-wide ungrouped keys',
        ungroupedPreviewTitle: 'Confirm deletion of {count} ungrouped API keys',
        ungroupedPreviewHint: 'These are all API keys system-wide without an active group, including keys with no group and keys whose original group was deleted. Review them before deleting.',
        deletedGroup: 'Deleted group #{id}',
        confirmDeleteUngroupedCount: 'Delete all {count}',
      ...
      rotateApiKeys: 'Rotate all keys',
      rotatingApiKeys: 'Rotating...',
      rotateApiKeysConfirm: 'Rotate all API keys for this user? Existing keys will stop working immediately.',
      rotateApiKeysSuccess: 'All API keys rotated',
      rotateApiKeysFailed: 'Failed to rotate API keys',
      group: 'Group',
      none: 'None',
