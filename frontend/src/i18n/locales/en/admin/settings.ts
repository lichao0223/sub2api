export default {
    settings: {
      ...
      loginIPBlock: {
        title: 'Failed Login IP Blocking',
        description: 'Count consecutive password failures by IP and block login when the threshold is reached.',
        enabled: 'Enable failed login IP blocking',
        enabledHint: 'Only invalid credentials count; a successful password check resets the counter immediately.',
        threshold: 'Consecutive failures',
        thresholdHint: 'Choose from 1 to 100 attempts. Blocking starts when this count is reached.',
        ...
        current: 'Currently blocked IPs',
        history: 'Block history (latest 1000)',
        emptyCurrent: 'No IP addresses are currently blocked.',
        emptyHistory: 'No block history.',
        blockedAt: 'Blocked at',
        remaining: 'Remaining',
        unblock: 'Unblock',
        unblockConfirm: 'Unblock login access for IP {ip}?',
        unblocked: 'IP block removed',
        remainingHours: '{hours}h {minutes}m',
        remainingMinutes: '{minutes}m',
        durationMinutes: '{minutes} minutes',
        event: { blocked: 'Blocked', unblocked: 'Manually unblocked' }
      },
      turnstile: {
