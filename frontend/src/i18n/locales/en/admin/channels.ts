export default {
    ...
    subscriptions: {
      ...
      allActiveUsers: 'Assign to all active users',
      allActiveUsersHint: 'Disabled and deleted users are excluded; existing subscriptions are reused.',
      bulkAssignConfirm: 'Assign this subscription to every active user in the system?',
      bulkAssignResult: 'Processed {success} users: {created} created, {reused} reused, {failed} failed',
