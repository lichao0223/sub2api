export default {
  ...
  admin: {
    ...
    users: {
      ...
      editUser: '编辑用户',
      deleteUser: '删除用户',
      deleteExternalUsers: '删除外部用户',
      deletingExternalUsers: '删除中...',
      confirmDeleteExternalUsers: '确认删除',
      deleteExternalUsersConfirm: '确定要删除所有通过外部接口创建或同步的用户吗？此操作会删除这些用户及其 API Key，且无法撤销。',
      externalUsersDeletedSuccess: '外部用户删除完成，已删除 {deleted} 个，失败 {failed} 个',
      failedToDeleteExternalUsers: '删除外部用户失败',
    ...
    usage: {
      ...
      nonworkCalendar: '非工作日历与回填',
      calendarConfirmed: '已确认',
      calendarPredicted: '预测',
      noCalendarStatus: '暂无日历状态',
      syncCalendar: '同步日历',
      ...
      offday: '休息日',
      workday: '工作日',
      saveCalendarDay: '保存日期',
      failedToLoadCalendarStatus: '加载非工作日历状态失败',
      calendarSyncAccepted: '日历同步已提交',
      calendarSyncFailed: '日历同步提交失败',
      nonworkBackfillAccepted: '非工作统计回填已提交',
      nonworkBackfillFailed: '非工作统计回填提交失败',
      calendarOverrideSaved: '日期修正已保存',
      calendarOverrideFailed: '日期修正保存失败',
      cleanup: {
        button: '清理',
        title: '清理使用记录',
