export default {
  ...
  tokenRanking: {
    ...
    requests: '请求数',
    tokens: 'Token 数',
    offdayTokens: '非工作日 Token',
    afterHoursTokens: '下班时间 Token',
    activeDuration: '活跃时长',
    spend: '消费',
    scope: '排名口径',
    scopeAll: '全部',
    scopeOffday: '非工作日',
    scopeAfterHours: '下班时间',
    scopeNonwork: '非工作时段',
    rankBy: '排名维度',
    ...
    rankBySpend: '消费',
    rankByOffdayTokens: '非工作日 Token',
    rankByAfterHoursTokens: '下班时间 Token',
    workTime: '工作时间',
    calendarPredicted: '日历未确认',
    totalTokens: '总 Token',
    totalRequests: '总请求数',
    totalSpend: '总消费',
    totalActiveDuration: '总活跃时长',
    export: '导出',
    exporting: '导出中...',
