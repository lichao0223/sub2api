export default {
  ...
  tokenRanking: {
    ...
    rankBy: 'Rank By',
    rankByTokens: 'Tokens',
    rankByNonworkTokens: 'Non-work Time Tokens',
    ...
    importNotePlaceholder: 'Optional import note',
    totalRows: 'Rows',
    matchedRows: 'Importable',
    overwriteRows: 'Overwrite',
    unmatchedRows: 'Unmatched (Ignored)',
    ...
    importStatus: 'Status',
    importError: 'Error',
    status_matched: 'Importable',
    status_overwrite: 'Overwrite',
    status_unmatched: 'Unmatched, Ignored',
    status_conflict: 'Conflict',
    status_invalid: 'Invalid',
    confirmImport: 'Confirm Import',
    emptyExcel: 'No importable rows in Excel',
    importParseFailed: 'Failed to parse Excel',
    missingRequiredColumns: 'Missing required columns: {columns}',
    requiredCellMissing: 'Row {row} misses required fields',
    importSuccess: 'Imported {count} external rows',
    importFailed: 'Failed to import external data',
    includeNonworkColumns: 'Include non-work fields',
    fileName: 'File Name',
    importedRows: 'Imported Rows',
    importedAt: 'Imported At',
    voidBatch: 'Void',
    voidBatchConfirm: 'Void this import batch? External stats written by this batch will be removed.',
    voidBatchSuccess: 'Import batch voided',
    voidBatchFailed: 'Failed to void import batch',
  ...
  admin: {
    ...
    users: {
      ...
      deleteExternalUsers: 'Delete External Users',
      deletingExternalUsers: 'Deleting...',
      confirmDeleteExternalUsers: 'Confirm Delete',
      deleteExternalUsersConfirm: 'Delete all users created or synced through the external integration APIs? This also deletes their API keys and cannot be undone.',
      externalUsersDeletedSuccess: 'External users deleted. Deleted {deleted}, failed {failed}.',
      failedToDeleteExternalUsers: 'Failed to delete external users',
    ...
    usage: {
      ...
      nonworkCalendar: 'Non-work Calendar and Backfill',
      calendarConfirmed: 'Confirmed',
      calendarPredicted: 'Predicted',
      noCalendarStatus: 'No calendar status',
      ...
      offday: 'Offday',
      workday: 'Workday',
      saveCalendarDay: 'Save Date',
      failedToLoadCalendarStatus: 'Failed to load non-work calendar status',
      calendarSyncAccepted: 'Calendar sync submitted',
      calendarSyncFailed: 'Failed to submit calendar sync',
      nonworkBackfillAccepted: 'Non-work stats backfill submitted',
      nonworkBackfillFailed: 'Failed to submit non-work stats backfill',
      calendarOverrideSaved: 'Calendar day override saved',
      calendarOverrideFailed: 'Failed to save calendar day override',
      cleanup: {
        button: 'Cleanup',
