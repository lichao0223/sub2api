export default {
    settings: {
      ...
      loginIPBlock: {
        title: '登录失败 IP 封禁',
        description: '按 IP 统计连续密码错误，达到阈值后阻止该 IP 登录。',
        enabled: '启用登录失败 IP 封禁',
        enabledHint: '仅账号密码验证失败计数；密码验证成功后立即清零。',
        threshold: '连续失败次数',
        thresholdHint: '允许设置 1 到 100 次。达到该次数后开始封禁。',
        duration: '封禁时长',
        duration30m: '30 分钟',
        duration1h: '1 小时',
        duration6h: '6 小时',
        duration1d: '1 天',
        duration7d: '7 天',
        durationPermanent: '永久封禁',
        current: '当前封禁 IP',
        history: '封禁历史（最近 1000 条）',
        emptyCurrent: '当前没有被封禁的 IP。',
        emptyHistory: '暂无封禁历史。',
        blockedAt: '封禁时间',
        remaining: '剩余时长',
        unblock: '解除封禁',
        unblockConfirm: '确定解除 IP {ip} 的登录封禁吗？',
        unblocked: 'IP 封禁已解除',
        remainingHours: '{hours} 小时 {minutes} 分钟',
        remainingMinutes: '{minutes} 分钟',
        durationMinutes: '{minutes} 分钟',
        event: { blocked: '封禁', unblocked: '手动解除' }
      },
      turnstile: {
