export default {
    ...
    subscriptions: {
      ...
      allActiveUsers: '分配给所有活跃用户',
      allActiveUsersHint: '自动排除已禁用和已删除用户；已有订阅会复用。',
      bulkAssignConfirm: '确定要给系统内所有活跃用户分配该订阅吗？',
      bulkAssignResult: '处理成功 {success} 人：新建 {created}，复用 {reused}，失败 {failed}',
