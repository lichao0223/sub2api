export default {
    ...
    usage: {
      ...
      nonworkCalendarDescription: '同步并维护每年的非工作日；手工添加的日期不会被后续同步覆盖。',
      calendarConfirmed: '已确认',
      calendarPredicted: '预测',
      noCalendarStatus: '暂无日历状态',
      syncCalendar: '同步日历',
      syncSelectedYear: '同步选中年份',
      yearOffdays: '{year} 年非工作日（{count} 天）',
      calendarDate: '日期',
      calendarName: '名称',
      calendarSource: '来源',
      calendarManual: '手工添加',
      noOffdays: '该年份暂无非工作日数据',
      addOffday: '添加非工作日',
      calendarNamePlaceholder: '可选，例如：公司假期',
      weekend: '周末',
      removeOffday: '移除',
      startDate: '开始日期',
      endDate: '结束日期',
