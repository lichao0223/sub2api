export default {
  ...
  tokenRanking: {
    ...
    scopeNonwork: '非工作时间',
    rankBy: '排名维度',
    rankByTokens: 'Token 数',
    rankByNonworkTokens: '非工作时间 Token',
    rankByRequests: '请求数',
    ...
    importNotePlaceholder: '导入备注，可选',
    totalRows: '总行数',
    matchedRows: '可导入',
    overwriteRows: '将覆盖',
    unmatchedRows: '未匹配（将忽略）',
    conflictRows: '冲突',
    invalidRows: '格式错误',
    excelRow: 'Excel 行',
    date: '日期',
    ...
    importError: '错误',
    status_matched: '可导入',
    status_overwrite: '将覆盖',
    status_unmatched: '未匹配，将忽略',
    status_conflict: '冲突',
    status_invalid: '格式错误',
    confirmImport: '确认导入',
    emptyExcel: 'Excel 中没有可导入数据',
    importParseFailed: '解析 Excel 失败',
    missingRequiredColumns: '缺少必填列：{columns}',
    requiredCellMissing: '第 {row} 行缺少必填字段',
    importSuccess: '已导入 {count} 条外部数据',
    importFailed: '导入外部数据失败',
    includeNonworkColumns: '包含非工作时间字段',
    fileName: '文件名',
    importedRows: '导入行数',
    importedAt: '导入时间',
    voidBatch: '作废',
    voidBatchConfirm: '确定作废这批导入数据吗？当前批次写入的外部统计会被移除。',
    voidBatchSuccess: '导入批次已作废',
    voidBatchFailed: '作废导入批次失败',
