...
func (r *usageBatchLogRepoStub) GetUserTokenRanking(context.Context, time.Time, time.Time, int) (*usagestats.UserTokenRankingResponse, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetUserNonworkTokenRanking(context.Context, time.Time, time.Time, string, string, string, string, []string, string, int) (*usagestats.UserNonworkTokenRankingResponse, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetNonworkStatsCoverage(context.Context, time.Time, time.Time, string) (usagestats.NonworkStatsCoverage, error) {
	return usagestats.NonworkStatsCoverage{}, nil
}
func (r *usageBatchLogRepoStub) PreviewExternalUsageImport(context.Context, usagestats.ExternalUsageImportInput) (*usagestats.ExternalUsageImportPreview, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) ImportExternalUsage(context.Context, usagestats.ExternalUsageImportInput) (*usagestats.ExternalUsageImportResult, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) ListExternalUsageImportBatches(context.Context, pagination.PaginationParams) ([]usagestats.ExternalUsageImportBatch, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
func (r *usageBatchLogRepoStub) VoidExternalUsageImportBatch(context.Context, int64, int64) error {
	return nil
}
...
func (r *usageBatchLogRepoStub) ExportExternalUsageRows(context.Context, time.Time, time.Time, bool) ([]usagestats.ExternalUsageImportRow, error) {
	return nil, nil
}
