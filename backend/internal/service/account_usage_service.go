...
type UsageLogRepository interface {
	...
	GetUserNonworkTokenRanking(ctx context.Context, startDate, endDate time.Time, scope, rankBy, sortOrder, timezone string, limit int) (*usagestats.UserNonworkTokenRankingResponse, error)
