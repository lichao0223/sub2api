...
type UserListFilters struct {
	...
	AllowedGroupID      int64  // Filter users allowed to use this group
	SubscriptionGroupID int64  // Filter users with an active, unexpired subscription for this group
