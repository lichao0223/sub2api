...
func registerRoutes(
	...
	routes.RegisterUserRoutes(v1, h, jwtAuth, adminAuth, auditLog, settingService, panelRateLimiter)
	routes.RegisterAdminRoutes(v1, h, adminAuth, auditLog, stepUpAuth, settingService, redisClient, panelRateLimiter)
	routes.RegisterIntegrationRoutes(v1, h, adminAuth, auditLog)
