...
func registerRoutes(
	...
	routes.RegisterUserRoutes(v1, h, jwtAuth, adminAuth, auditLog, settingService)
	routes.RegisterAdminRoutes(v1, h, adminAuth, auditLog, stepUpAuth, settingService, redisClient)
