...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/lichao0223/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="lichao0223/sub2api"
...
Documentation=https://github.com/lichao0223/sub2api
